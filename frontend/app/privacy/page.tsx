  ...
  return (
    <main className="mm-page text-sm leading-relaxed scrollbar-thin">
      ...
      <section className="mt-8 space-y-4 text-zinc-700">
        <p>
          <strong className="text-zinc-900">Какие данные:</strong> email и пароль для учётной записи, имя
        ...
        <p>
          <strong className="text-zinc-900">Зачем:</strong> регистрация, расчёт совпадений, отображение ленты и
          чатов, безопасность и противодействие злоупотреблениям.
        </p>
        <p>
          <strong className="text-zinc-900">Показ другим:</strong> в ленте и профилях другие пользователи видят
          псевдоним и результаты совместимости, но не ваш email. В групповых чатах виден псевдоним и сообщения в
          комнате.
        </p>
        <p>
          <strong className="text-zinc-900">Хранение:</strong> данные хранятся в базе приложения; в разработке
          часто используется локальный SQLite, на проде — отдельная БД с резервным копированием по вашей
          инфраструктуре.
        </p>
        <p>
          <strong className="text-zinc-900">Ваши действия:</strong> вы можете запросить удаление аккаунта у
