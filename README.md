...
1. **Коммуникации в стиле Threads:** сделать слой общения максимально похожим на [Threads](https://www.threads.com/?hl=ru) — лента как “домашняя” с постами/ветками, быстрые реакции, репост/цитата, подписки/фолловинг, профиль автора и “социальные” счётчики; при этом сохранить «псевдонимы/приватность» как у MatchMe.
